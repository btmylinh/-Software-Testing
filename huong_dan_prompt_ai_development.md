...
### [Mẹo Prompt cho các loại dự án](#mẹo-prompt-cho-các-loại-dự-án)
- [FRONTEND - Giao Diện Người Dùng](#frontend---giao-diện-người-dùng)
- [BACKEND - Phần Xử Lý Phía Sau](#backend---phần-xử-lý-phía-sau)
- [FULLSTACK - Kết Nối 2 Phần](#fullstack---kết-nối-2-phần)
- [SỬA LỖI VÀ TỐI ƯU](#sửa-lỗi-và-tối-ưu)
- [Các Mẫu Lệnh Hay Dùng](#các-mẫu-lệnh-hay-dùng)

### [Quản lý TODO và chia Sessions hiệu quả](#quản-lý-todo-và-chia-sessions-hiệu-quả)
- [Khả Năng Xử Lý Tối Ưu Của AI](#khả-năng-xử-lý-tối-ưu-của-ai)
- [Cách Thực Hiện Cơ Bản](#cách-thực-hiện-cơ-bản)
- [Quy Tắc Quan Trọng](#quy-tắc-quan-trọng)
- [Framework Cho Session Cuối Chuẩn](#framework-cho-session-cuối-chuẩn)

### [Ví Dụ Thực Tế](#ví-dụ-thực-tế)
- [Ví Dụ 1: Frontend-Only Banner Management](#ví-dụ-1-frontend-only-banner-management-dom--alpinejs)
- [Ví Dụ 2: Backend-Only Banner Management](#ví-dụ-2-backend-only-banner-management-api-đã-có-frontend)

### [Xây dựng dự án từ đầu](#xây-dựng-dự-án-từ-đầu)
- [Tình Huống](#tình-huống)
- [BƯỚC 1: Prompt Phân Tích Và Lên Kế Hoạch](#bước-1-prompt-phân-tích-và-lên-kế-hoạch-tổng-thể-theo-hướng-đối-tượng)
- [BƯỚC 2: Kế Hoạch Các Giai Đoạn Development](#bước-2-kế-hoạch-các-giai-đoạn-development)
- [BƯỚC 3: Quy Trình Chia Nhỏ](#bước-3-quy-trình-chia-nhỏ-từ-roadmap--tasks-cụ-thể)
- [BƯỚC 4: Execute Tasks](#bước-4-execute-tasks-với-todo-sessions)

### [Phân tích code có sẵn và làm tiếp](#phân-tích-code-có-sẵn-và-làm-tiếp)
- [BƯỚC 1: Phân Tích Code Có Sẵn](#bước-1-phân-tích-code-có-sẵn)
- [BƯỚC 2: Hiểu Design System](#bước-2-hiểu-design-system-có-sẵn)
- [BƯỚC 3: Hiểu Backend Patterns](#bước-3-hiểu-backend-patterns)
- [BƯỚC 4: Tạo Tính Năng Mới](#bước-4-tạo-tính-năng-mới-với-context)
- [Mẹo Thực Chiến](#mẹo-thực-chiến)

### [Prompt cho các mô hình dự án khác nhau](#prompt-cho-các-mô-hình-dự-án-khác-nhau)
- [CÔNG THỨC QUAN TRỌNG](#công-thức-quan-trọng)
- [MVC vs API](#mvc-vs-api---cách-thay-đổi-prompt)
- [WEB vs MOBILE](#web-vs-mobile---platform-specific-prompts)
- [KIẾN TRÚC DỰ ÁN](#kiến-trúc-dự-án---prompt-templates)
- [FRAMEWORK-SPECIFIC](#framework-specific-prompt-adjustments)
- [Kết Luận](#kết-luận)
...
#### **Kết Quả Trả Về Thực Hiện Từng Session Ở Bước 2**
...
Đã có sẵn danh sách yêu cầu chức năng, database, công nghệ. Khi bắt đầu một dự án hoàn toàn mới, cần chia nhỏ và có hệ thống để làm việc hiệu quả.
...
PHÂN TÍCH: 
Chia thành 4 phases, 
phases 1 luôn là Foundation & Infrastructure authentication
...
- Cụ thể hóa yêu cầu thay vì nói chung chung
- Thiết lập consistency khi làm nhiều trang/API
- Phân tích trước khi làm việc với code có sẵn
- Sử dụng template và từ khóa mạnh
